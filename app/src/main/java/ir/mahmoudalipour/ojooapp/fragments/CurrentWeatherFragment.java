package ir.mahmoudalipour.ojooapp.fragments;
...
import ir.mahmoudalipour.ojooapp.R;
import ir.mahmoudalipour.ojooapp.adapters.ForecastAdapter;
import ir.mahmoudalipour.ojooapp.model.openweathermap.Current.Current;
import ir.mahmoudalipour.ojooapp.model.openweathermap.forecast.Forecast;
import ir.mahmoudalipour.ojooapp.model.openweathermap.forecast.List;
import ir.mahmoudalipour.ojooapp.model.openweathermap.forecast.Weather;
...
public class CurrentWeatherFragment extends Fragment {
    ...
    static final String weatherApiId = "&APPID=d8848fb2a6d94ea1309cf0b74c498fb0";
    ...
    private void getCurrentWeatherData(String cityName, String countryCode) {
        ...
        currentWeatherClient.get(currentWeatherUrl, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                Gson gson = new Gson();
                Current currentWeatherResponse = gson.fromJson(response.toString(), Current.class);
    ...
    private void getForecastWeatherData(String cityName, String countryCode) {
        ...
        forecastWeatherClient.get(forecastWeatherUrl, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                Gson gson = new Gson();
                Forecast weatherResponse = gson.fromJson(response.toString(), Forecast.class);
